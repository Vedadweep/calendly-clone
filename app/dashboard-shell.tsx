      ...
      <header className="sticky top-0 z-40 border-b border-white/70 bg-white/82 backdrop-blur-2xl">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav
            ...
            } w-full flex-col gap-2 rounded-[22px] border border-slate-200/70 bg-white/80 p-1.5 shadow-[0_12px_28px_rgba(15,23,42,0.05)] lg:flex lg:w-auto lg:flex-row lg:flex-wrap`}
          >
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`rounded-2xl px-4 py-3 text-center text-sm font-semibold transition lg:min-w-[8.5rem] ${
                    isActive
