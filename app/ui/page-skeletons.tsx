      ...
      <main className="dashboard-page">
        <div className="dashboard-container flex flex-col gap-8 lg:gap-10">
          <section className="hero-panel animate-pulse p-6 sm:p-8 lg:p-10">
            ...
            <div className="mt-5 h-11 max-w-2xl rounded-full bg-slate-700/70" />
            <div className="mt-4 h-5 max-w-3xl rounded-full bg-slate-700/60" />
            <div className="mt-3 h-5 max-w-2xl rounded-full bg-slate-700/50" />
          </section>
          ...
          <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: cards }).map((_, index) => (
              ...
              >
                ...
                <div className="mt-6 h-8 w-2/3 rounded-full bg-slate-700" />
                <div className="mt-3 h-4 w-full rounded-full bg-slate-700" />
                <div className="mt-10 h-11 w-full rounded-2xl bg-slate-700" />
              </article>
            ))}
          </section>
        </div>
      ...
      <div className="dashboard-container flex max-w-6xl flex-col gap-6 lg:gap-8">
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
          <div className="surface-panel min-h-[28rem] animate-pulse p-6">
            ...
            <div className="mt-6 h-80 rounded-[24px] bg-slate-800" />
          </div>
          <div className="surface-panel min-h-[28rem] animate-pulse p-6">
